...
public class Main {
	...
	printList ("Unsorted songList", songs);

	Collections.sort(songs);
	printList ("Sorted Default songList", songs);

	Collections.sort(songs, new SongByAlbumn());
	printList ("Sorted By Albumn songList", songs);

	Collections.sort(songs, new SongByAlbumn());
	printList ("Sorted By Artist songList", songs);
